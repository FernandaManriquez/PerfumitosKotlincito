...
data class CreateProductRequest(
    ...
    @SerializedName("imagenes") val images: List<ProductImage>?,
    @SerializedName("images") val images2: List<ProductImage>? = null,
    @SerializedName("imagenes_ids") val imageIds: List<Int>? = null,
    @SerializedName("imagenes_paths") val imagePaths: List<String>? = null
)
